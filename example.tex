...
% \documentclass[fontset = founder]{exam-zh}

\examsetup{
  page = {
    size       = a4paper,         % 页面尺寸：a3paper|a4paper
    % foot-style  = separate,        % 两页是否共用页脚（仅对style = a3paper 生效）：common|separate
  },
  sealline = {
    show        = true,
    % scope        = firstpage,
    ...
    odd-info-content     = {
      ...
      {\kaishu 准考证号} {\examsquare{9}},
      {\kaishu 考场号} {\examsquare{2}},
      {\kaishu 座位号} {\examsquare{2}},
    },
  ...
  question = {
    answer-color = black,
    show-points  = auto,    % 显示题目分数
    show-paren   = true,    % 显示选择题括号
    show-answer  = false,    % 显示答案
...
% 13.
\begin{question}
  已知函数 $f(x) = x^3 (a \cdot 2^x - 2^{-x})$ 是偶函数，则 $a = $ \fillin[type = paren][$1$] 。
\end{question}
