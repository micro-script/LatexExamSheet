...
\examsetup{
  page = {
    style       = a4paper,         % 页面尺寸：a3paper|a4paper
    % foot-style  = common,        % 两页是否共用页脚（仅对style = a3paper 生效）：common|separate
  },
  sealline = {
    show-sealline        = true,
    % sealline-type      = firstpage,
    % sealline-type      = oddpage,
    sealline-type        = everypage,
