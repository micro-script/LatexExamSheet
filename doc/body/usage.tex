...
\begin{latexexample}{\env{material} 环境示例}
  \begin{material}[title = \LaTeX{} 入门, author = 夏大鱼羊, format = {\sffamily \zihao{-4}},source={（摘自《夏大鱼羊自传》）}]
...
\begin{function}[updated = 2022-07-24]{material/title-format}
  ...
  \end{ccnusyntax}
  \env{material} 环境的上方标题的 \emph{格式}。默认为 |\large|。
\end{function}
...
\begin{function}[updated = 2022-07-24]{material/title-material-sep}
  \begin{ccnusyntax}[emph={[1]title-material-sep}]
    title-material-sep = (*\meta{弹性长度}*)
  \end{ccnusyntax}
  \env{material} 环境和上方标题的间距。默认为 |2em|。
\end{function}
...
\begin{function}[added = 2022-07-24]{material/top-sep}
  \begin{ccnusyntax}[emph={[1]top-sep}]
    top-sep = (*\meta{弹性长度}*)
  \end{ccnusyntax}
  \env{material} 环境和标题（如果有）的整体上方间距。默认为 |.5em plus .5em minus .5em|。
\end{function}
...
\begin{function}[added = 2022-07-24]{material/title-material-sep}
  \begin{ccnusyntax}[emph={[1]title-material-sep}]
    title-material-sep = (*\meta{弹性长度}*)
  \end{ccnusyntax}
  \env{material} 环境和标题（如果有）的间距。默认为 |.5em minus .5em|。
\end{function}