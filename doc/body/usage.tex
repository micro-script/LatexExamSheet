...
\begin{enumerate}
  ...
  \item 文字和图片左右或上下排版
  \item 文字绕排（主要基于李清的 \pkg{wrapstuff} 宏包）
\end{enumerate}
...
\begin{function}[added = 2022-08-27]{choices/top-sep}
  \begin{ccnusyntax}[emph={[1]top-sep}]
...
\begin{function}[added = 2022-08-27]{choices/bottom-sep}
  \begin{ccnusyntax}[emph={[1]bottom-sep}]
...
\begin{function}[added = 2022-08-27]{choices/linesep}
